...
class FlxGame extends Sprite
{
	...
	{
        /**
            FIXED: slow animations.
        **/
		if (FlxG.fixedTimestep)
		{
			FlxG.elapsed = (FlxG.timeScale * _stepSeconds) * FlxG.globalSpeed; // fixed timestep and fixed anims
		}
		else
		{
			FlxG.elapsed = (FlxG.timeScale * (_elapsedMS / 1000)) * FlxG.globalSpeed; // variable timestep and time
