...
class FlxSound extends FlxBasic
{
	...
	/**
	 * Current pitch of the Sound & used for death by osu.
	 */
	...
	function reset():Void
	{
		...
		_pitch = FlxG.changeGlobalPitch ? FlxG.globalSpeed : 1.0;
	...
	override public function update(elapsed:Float):Void
	{
		if (!playing)
			return;
		if (FlxG.changeGlobalPitch && FlxG.globalSpeed  != pitch) pitch =FlxG.globalSpeed;
	...
	function updateTransform():Void
	{
		...
		if (_channel != null)
		{
            ...
            #if cpp
			@:privateAccess if(_channel.__source != null)  _channel.__source.__backend.set_pit(FlxG.changeGlobalPitch ? FlxG.globalSpeed : _pitch );
            #end
		}
	}
