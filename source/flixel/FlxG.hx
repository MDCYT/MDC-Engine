...
{
	/**
	* A map to callbacks custom events.
	*/
	...
	/**
	 * Used to change te pitch
	 */
	public static var globalSpeed(default, null):Float =  1.0;
	/**
	 * Used to change te pitch
	 */
	public static var changeGlobalPitch(default, null):Bool =  true;
	/**
	 * Change a global speed,
	 * @param value  value to change
	 * @param changePitchOfSounds  if it is true, changes all sounds to this value.
	 */
	public static function setGlobalSpeed(value:Float = 1.0, ?changePitchOfSounds:Bool = true):Float
	{
		globalSpeed = value;
		changeGlobalPitch = changePitchOfSounds;
		if (callBacks.get("onChangeSpeed") != null)
			callBacks.get("onChangeSpeed")(value);
		return value;
	}
	/**
	 ...
	 */
	public static inline function switchState(nextState:FlxState,?calledByMusic:Bool = false):Void
	{		
