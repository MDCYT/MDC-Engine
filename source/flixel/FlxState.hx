...
class FlxState extends FlxGroup
{
	...
	public function initCameras():Void
	{
		...
		FlxG.updateFramerate = PlayerSettings.FPS;
		FlxG.drawFramerate = PlayerSettings.FPS;
	}
	/**
