...
class StatsMenu extends MusicBeatSubstate
{
	...
	public function new(x:Float, y:Float)
	{
		...
		FlxTween.tween(scoreText, {alpha: 1, y: scoreText.y + 5}, 0.4, {ease: FlxEase.quartInOut, startDelay: 0.5});
	...
	override function update(elapsed:Float)
	{
		...
		var accepted = FlxG.keys.justPressed.TAB;
